...
module group4_project_system_addr_router_default_decode
  #(
...
module group4_project_system_addr_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    group4_project_system_addr_router_default_decode the_default_decode(
