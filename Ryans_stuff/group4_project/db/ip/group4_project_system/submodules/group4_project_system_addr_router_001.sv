...
module group4_project_system_addr_router_001_default_decode
  #(
...
module group4_project_system_addr_router_001
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD12 = log2ceil(64'h1109073 - 64'h1109072);
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1109073;
    ...
    group4_project_system_addr_router_001_default_decode the_default_decode(
    ...
    always @* begin
        ...
        // ( 0x1109072 .. 0x1109073 )
        if ( {address[RG:PAD12],{PAD12{1'b0}}} == 25'h1109072 ) begin
